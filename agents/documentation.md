...
| `docs/` | — | normative contracts: `CONTRACT.md`, `API.md`, `EXTRACTOR.md`; `ADOPTING.md` — guide for an agent in a consuming project | edited together with the code they govern |
