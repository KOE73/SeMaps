...
| File | What | State |
|---|---|---|
| `check.go` | `semaps check`: stale translations, divergences, missing texts, views without an axis, containment contradictions, broken `codeRef`, placeholder names, undeclared relation types | works |
