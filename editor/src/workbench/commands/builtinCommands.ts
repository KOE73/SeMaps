...
export function createBuiltinCommands(): CommandDefinition[] {
  return [
    ...
    {
      id: "file.discard.view",
      title: "Отменить несохранённое у вида",
      description: "Вернуть геометрию открытого вида к файлу",
      icon: "↩",
      category: "File",
      isEnabled: (ctx) => ctx.editor.currentView !== null,
      execute: (ctx) => ctx.editor.discardCurrentView(),
    },
    {
      id: "file.discard.registry",
      title: "Отменить несохранённое у реестра",
      description: "Вернуть сущности, связи и тексты к файлам",
      icon: "↩",
      category: "File",
      isEnabled: (ctx) => ctx.editor.currentView !== null,
    ...
    },
    {
      ...
      get title() { return i18n.d.commands.alignLeft.title; },
      get description() { return i18n.d.commands.alignLeft.desc; },
      icon: "⇤",
      category: "Diagram",
      isEnabled: (ctx) => ctx.canvas.selectedElements().length > 1,
      execute: (ctx) => ctx.editor.alignSelection("left"),
    },
    {
      id: "diagram.align.right",
      get title() { return i18n.d.commands.alignRight.title; },
      get description() { return i18n.d.commands.alignRight.desc; },
      icon: "⇥",
      category: "Diagram",
      isEnabled: (ctx) => ctx.canvas.selectedElements().length > 1,
      execute: (ctx) => ctx.editor.alignSelection("right"),
    },
    {
      id: "diagram.align.top",
      get title() { return i18n.d.commands.alignTop.title; },
      get description() { return i18n.d.commands.alignTop.desc; },
      icon: "⤒",
      category: "Diagram",
      isEnabled: (ctx) => ctx.canvas.selectedElements().length > 1,
      execute: (ctx) => ctx.editor.alignSelection("top"),
    },
    {
      id: "diagram.align.bottom",
      get title() { return i18n.d.commands.alignBottom.title; },
      get description() { return i18n.d.commands.alignBottom.desc; },
      icon: "⤓",
      category: "Diagram",
      isEnabled: (ctx) => ctx.canvas.selectedElements().length > 1,
      execute: (ctx) => ctx.editor.alignSelection("bottom"),
    },
    {
      id: "diagram.align.width",
      get title() { return i18n.d.commands.alignWidth.title; },
      get description() { return i18n.d.commands.alignWidth.desc; },
      icon: "↔",
      category: "Diagram",
      isEnabled: (ctx) => ctx.canvas.selectedElements().length > 1,
      execute: (ctx) => ctx.editor.alignSelection("width"),
    },
    {
      id: "diagram.align.height",
      get title() { return i18n.d.commands.alignHeight.title; },
      get description() { return i18n.d.commands.alignHeight.desc; },
      icon: "↕",
      category: "Diagram",
      isEnabled: (ctx) => ctx.canvas.selectedElements().length > 1,
      execute: (ctx) => ctx.editor.alignSelection("height"),
    },
    {
      id: "diagram.alignEdge.left",
      get title() { return i18n.d.commands.alignEdgeLeft.title; },
      get description() { return i18n.d.commands.alignEdgeLeft.desc; },
      icon: "⇠",
      category: "Diagram",
      isEnabled: (ctx) => ctx.canvas.selectedElements().length > 1,
      execute: (ctx) => ctx.editor.alignEdges("left"),
    },
    {
      id: "diagram.alignEdge.right",
      get title() { return i18n.d.commands.alignEdgeRight.title; },
      get description() { return i18n.d.commands.alignEdgeRight.desc; },
      icon: "⇢",
      category: "Diagram",
      isEnabled: (ctx) => ctx.canvas.selectedElements().length > 1,
      execute: (ctx) => ctx.editor.alignEdges("right"),
    },
    {
      id: "diagram.alignEdge.top",
      get title() { return i18n.d.commands.alignEdgeTop.title; },
      get description() { return i18n.d.commands.alignEdgeTop.desc; },
      icon: "⇡",
      category: "Diagram",
      isEnabled: (ctx) => ctx.canvas.selectedElements().length > 1,
      execute: (ctx) => ctx.editor.alignEdges("top"),
    },
    {
      id: "diagram.alignEdge.bottom",
      get title() { return i18n.d.commands.alignEdgeBottom.title; },
      get description() { return i18n.d.commands.alignEdgeBottom.desc; },
      icon: "⇣",
      category: "Diagram",
      isEnabled: (ctx) => ctx.canvas.selectedElements().length > 1,
      execute: (ctx) => ctx.editor.alignEdges("bottom"),
    },
    {
