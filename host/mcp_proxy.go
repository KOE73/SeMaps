...
func projectTool(name string) bool {
	switch name {
	case "list_views", "get_entity", "find_entities", "get_relations", "get_relation_types", "get_view", "get_text", "set_text", "add_relation", "add_relation_type", "set_relation_visible", "confirm_rename", "place_entities", "save", "discard":
		return true
	}
	return false
}
